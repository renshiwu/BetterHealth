...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            ...
            mPtrIndicator.setResistance(6.0f);
...
//                    arr.getFloat(R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));
    ...
    final public void refreshComplete() {
        ...
        if (mRefreshCompleteLitener != null) {
            mRefreshCompleteLitener.RefreshComplete();
        }
    ...
    public interface OnRefreshCompleteLitener {
        void RefreshComplete();
    }

    private OnRefreshCompleteLitener mRefreshCompleteLitener;

    public void setOnRefreshCompleteLitener(OnRefreshCompleteLitener mRefreshCompleteLitener) {
        this.mRefreshCompleteLitener = mRefreshCompleteLitener;
    }
