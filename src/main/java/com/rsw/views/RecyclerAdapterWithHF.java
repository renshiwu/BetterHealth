...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolderHF(ViewHolder holder, int position) {
    ...
    private void prepareHeaderFooter(HeaderFooterViewHolder vh, View view) {
        // if it's a staggered com.rtrs.betterpartybuild.grid, span the whole layout
    ...
    public void setStartAnim(boolean start) {
        startAnim = start;
    }
