...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public com.vector.update_app.UpdateDialogFragment setUpdateDialogFragmentListener(IUpdateDialogFragmentListener updateDialogFragmentListener) {
        this.mUpdateDialogFragmentListener = updateDialogFragmentListener;
        return this;
    }


    public static com.vector.update_app.UpdateDialogFragment newInstance(Bundle args) {
        com.vector.update_app.UpdateDialogFragment fragment = new com.vector.update_app.UpdateDialogFragment();
        if (args != null) {
...
//            }
    ...
    private void installApp() {
        if (AppUpdateUtils.appIsDownloaded(mUpdateApp)) {
            AppUpdateUtils.installApp(com.vector.update_app.UpdateDialogFragment.this, AppUpdateUtils.getAppFile(mUpdateApp));
            //安装完自杀
    ...
    private void startDownloadApp(DownloadService.DownloadBinder binder) {
        ...
        if (mUpdateApp != null) {
            ...
            binder.start(mUpdateApp, new DownloadService.DownloadCallback() {
                @Override
                public void onStart() {
                    if (!com.vector.update_app.UpdateDialogFragment.this.isRemoving()) {
    ...
    private void showInstallBtn(final File file) {
        ...
        mUpdateOkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppUpdateUtils.installApp(com.vector.update_app.UpdateDialogFragment.this, file);
            }
        });
    }
