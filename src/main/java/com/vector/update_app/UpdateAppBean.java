...
public class UpdateAppBean implements Serializable {
    ...
    public com.vector.update_app.UpdateAppBean setConstraint(boolean constraint) {
    ...
    public com.vector.update_app.UpdateAppBean setUpdate(String update) {
        this.update = update;
        return this;
    }
    ...
    public com.vector.update_app.UpdateAppBean setNewVersion(String new_version) {
        this.new_version = new_version;
        return this;
    }
    ...
    public com.vector.update_app.UpdateAppBean setApkFileUrl(String apk_file_url) {
    ...
    public com.vector.update_app.UpdateAppBean setUpdateLog(String update_log) {
    ...
    public com.vector.update_app.UpdateAppBean setUpdateDefDialogTitle(String updateDefDialogTitle) {
    ...
    public com.vector.update_app.UpdateAppBean setNewMd5(String new_md5) {
    ...
    public com.vector.update_app.UpdateAppBean setTargetSize(String target_size) {
    ...
    public com.vector.update_app.UpdateAppBean setOriginRes(String originRes) {
