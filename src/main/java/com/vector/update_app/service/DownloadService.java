...
public class DownloadService extends Service {
    ...
    private static final String       TAG          = com.vector.update_app.service.DownloadService.class.getSimpleName();
    ...
    public static void bindService(Context context, ServiceConnection connection) {
        Intent intent = new Intent(context, com.vector.update_app.service.DownloadService.class);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context.startForegroundService(intent);
        } else {
            context.startService(intent);
    ...
    private void stop(String contentText) {
        if (mBuilder != null) {
            mBuilder.setContentTitle(AppUpdateUtils.getAppName(com.vector.update_app.service.DownloadService.this))
    ...
    public class DownloadBinder extends Binder {
        ...
        public void stop(String msg) {
            com.vector.update_app.service.DownloadService.this.stop(msg);
        }
    }
    ...
    class FileDownloadCallBack implements HttpManager.FileCallback {
        ...
        public void onProgress(float progress, long total) {
            ...
            if (oldRate != rate) {
                ...
                if (mBuilder != null) {
                    mBuilder.setContentTitle("正在下载：" + AppUpdateUtils.getAppName(com.vector.update_app.service.DownloadService.this))
                            .setContentText(rate + "%")
        ...
        public void onError(String error) {
            Toast.makeText(com.vector.update_app.service.DownloadService.this, "更新新版本出错，" + error, Toast.LENGTH_SHORT).show();
            //App前台运行
            if (mCallBack != null) {
        ...
        public void onResponse(File file) {
            ...
            try {
                if (AppUpdateUtils.isAppOnForeground(com.vector.update_app.service.DownloadService.this)) {
                    //App前台运行
                    mNotificationManager.cancel(NOTIFY_ID);
                    if (mCallBack != null) {
                        boolean temp = mCallBack.onInstallAppAndAppOnForeground(file);
                        if (!temp) {
                            AppUpdateUtils.installApp(com.vector.update_app.service.DownloadService.this, file);
                        }
                    } else {
                        AppUpdateUtils.installApp(com.vector.update_app.service.DownloadService.this, file);
                    }
                    ...
                    Intent installAppIntent = AppUpdateUtils.getInstallAppIntent(com.vector.update_app.service.DownloadService.this, file);
                    PendingIntent contentIntent = PendingIntent.getActivity(com.vector.update_app.service.DownloadService.this, 0, installAppIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                    mBuilder.setContentIntent(contentIntent)
                            .setContentTitle(AppUpdateUtils.getAppName(com.vector.update_app.service.DownloadService.this))
