...
import com.rsw.util.APKVersionCodeUtils;
...
public class UpdateAppManager {
    ...
    private static final String TAG            = com.vector.update_app.UpdateAppManager.class.getSimpleName();
    ...
    private void processData(String result, @NonNull UpdateCallback callback) {
        try {
            ...
            int localVerCode = APKVersionCodeUtils.getVersionCode(mActivity);
            System.out.println("mUpdateApp.getCode()============="+mUpdateApp.getCode());
            if (mUpdateApp.getCode() > localVerCode) {
    ...
    public static class Builder {
         ...
         * @return 生成app管理器
         */
        public com.vector.update_app.UpdateAppManager build() {
            //校验
            ...
            return new com.vector.update_app.UpdateAppManager(this);
        }
